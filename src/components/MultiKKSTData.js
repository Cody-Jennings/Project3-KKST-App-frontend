...
export default function MultiKKSTData() {
  ...
  return (
    ...
    <div className='multiContainer'>
      ...
      <h4>Are you an "old-soul/old-timer" or "un-hip" by todays standards and wanting to understand the new and odd phrases?
        Look no further as this app will help make you the koolest kid on the block!</h4><br></br>
